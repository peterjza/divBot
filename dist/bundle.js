...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Robot = __webpack_require__(301);

	var css = __webpack_require__(302);
	...
	(function () {
	    ...
	    var board = new _Board.Board(boardSize);
	    var robot = new _Robot.Robot(board);
	    var ui = new _Interface.Interface(robot);
...
/***/ function(module, exports) {
	...
	var Board = exports.Board = function () {
	    ...
	    _createClass(Board, [{
	        key: 'isValidPosition',
	        value: function isValidPosition(posArr) {

	            // we check if the posArr is valid against our board
	            return this.isValidXY(posArr[0]) && this.isValidXY(-posArr[1]) && this.isValidDirection(posArr[2]);
	        }
	    }, {
	        key: 'isValidDirection',
	        value: function isValidDirection(direction) {

	            return this.directions.find(function (x) {
	                return x === direction;
	            });
	        }
	    }, {
	        key: 'isValidXY',
	        value: function isValidXY(xy) {
	...
	var Interface = exports.Interface = function () {
	    function Interface(robot) {
	        ...
	        document.onkeydown = function (evt) {
	            ...
	            switch (evt.keyCode) {
	                case 37:
	                    _this.inputCommand(["left"]);
	                    break;
	                case 38:
	                    _this.inputCommand(["move"]);
	                    break;
	                case 39:
	                    _this.inputCommand(["right"]);
	                    break;
	            }
	        };
	    ...
	    _createClass(Interface, [{
	        key: "sanitize",
	        value: function sanitize(input, e) {
	            ...
	            var sanitizedValueArray = val.trim().toLocaleLowerCase().replace(regEx, ' ').split(' ').filter(function (e) {
	                return e;
	            });
	        ...
	        key: "inputCommand",
	        value: function inputCommand(cmdArr) {
	        ...
	        value: function buildUI() {
	            ...
	            btnNav.addEventListener("click", function (e) {
	                ...
	                if (e.target !== e.currentTarget) {
	                    ...
	                    var cmd = e.target.parentNode.dataset.command;

	                    if (cmd == null) return;

	                    _this2.inputCommand([cmd]);
	                }
	                e.stopPropagation();
	            }, false);
	        }
	        ...
	        key: "buildTeleporter",
	        value: function buildTeleporter() {
	            var _this3 = this;
	            ...
	            var grid = document.getElementById("teleportPad");
	            ...
	            grid.addEventListener("click", function (e) {
	                ...
	                if (e.target !== e.currentTarget) {
	                    var x = e.target.dataset.item,
	                        y = e.target.parentNode.dataset.list;

	                    if (x == null || y == null) return;

	                    var teleportArr = ["place", x, y, _this3.robot.facing || "north"];

	                    _this3.inputCommand(teleportArr);
	                }
	                e.stopPropagation();
	            }, false);
	        }
	...
	var Robot = exports.Robot = function () {
	        ...
	        _createClass(Robot, [{
	                ...
	                value: function report() {
	                        ...
	                        if (!this.placed) return this.reject();

	                        // if( this.placed )
	                        var block = -this.posY * 5 + this.posX,
	                        ...
	                        var speak = list[block].appendChild(heading);
	                ...
	                value: function place(arr, idx) {
	                        ...
	                        var posArr = Array.of(arr[idx], -arr[idx + 1], arr[idx + 2]);

	                        // if new posArr board.isValid ;
	                        if (this.board.isValidPosition(posArr)) {
	                                var _ret = function () {

	                                        var list = _this2.commandList.getElementsByTagName('li');

	                                        for (var i = 0; i < 3; i++) {

	                                                _this2.commandArr.shift();
	                                        }
	                                        ...
	                                        _this2.el.classList.remove("teleportIn");
	                                        void _this2.el.offsetWidth;
	                                        _this2.el.classList.add("teleportIn");

	                                        setTimeout(function () {

	                                                _this2.commandList.removeChild(list[0]);
	                                                _this2.commandList.removeChild(list[0]);
	                                                _this2.commandList.removeChild(list[0]);
	                                                _this2.posX = parseInt(posArr[0]);
	                                                _this2.posY = parseInt(posArr[1]);
	                                                _this2.facing = posArr[2];
	                                                _this2.rotation = _this2.getFacingIdx() * 90;
	                ...
	                key: "getFacingIdx",
	                value: function getFacingIdx() {
	                        var _this3 = this;

	                        return this.board.directions.findIndex(function (i) {
	                                return i === _this3.facing;
	                        });
	                }
	        }, {
	                key: "setFacingByIdx",
	                value: function setFacingByIdx(idx) {
	                ...
	                value: function animate() {
	                        ...
	                        this.el.style.transform = "translate(" + this.posX * 100 + 'px,' + this.posY * 100 + "px) rotate(" + this.rotation + "deg)";
	                }
	        }, {
	                key: "left",
	                value: function left() {
	                ...
	                value: function move() {
	                        ...
	                        var posArr = Array.of(currPosX, currPosY, this.facing);
	                ...
	                key: "addCommand",
	                value: function addCommand(cmdArr) {
	                        var _this5 = this;
	                        ...
	                        if (this.commandArr.length == 0) {
	                                ...
	                                setTimeout(function () {
	                                        _this5.executeCommandList();
	                                }, 1400);
	                        }
	                        this.commandArr.push(cmdArr);
	                }
	        }, {
	                key: "executeCommandList",
	                value: function executeCommandList() {
	                        var _this6 = this;
	                        ...
	                        var cmd = this.commandArr[0],
	                            cmdResult = void 0;

	                        this.commandArr.shift();

	                        if (this.allowedInputs.find(function (i) {
	                                return i == cmd;
	                        })) {
	                        ...
	                        var firstItem = document.getElementsByClassName('pending');
	                        ...
	                        setTimeout(function () {
	                                ...
	                                var firstItem = _this6.commandList.getElementsByTagName('li');
